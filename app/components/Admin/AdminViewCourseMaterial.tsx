                                                    ...
                                                    <div>
                                                        {
                                                            item?.videos.map((item, index) => (
                                                                <Link href={`/admin/view-course/${courseId}/lecture/${item.id}`} key={index} className="material-box">
                                                                    <div>
                                                                        <Image
                                                                            aria-hidden
...
export default AdminViewCourseMaterial